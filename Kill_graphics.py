...
pivot_table = df_modes.pivot(index="Mode",columns="Game", values="AvgKills")

# Creating the heatmap
plt.figure(figsize=(10, 6))
heatmap = sns.heatmap(pivot_table, fmt=".1f", linewidths=.5, cmap="coolwarm")
plt.title('Heatmap of Average Kills by Mode and Game Version')
plt.ylabel('Mode')
...
SELECT
    ...
    AVG(Kills_mode1_team1_avg) as AvgKills
FROM processed_averages
GROUP BY Game
UNION ALL
SELECT
    ...
    AVG(Kills_mode1_team2_avg) as AvgKills
FROM processed_averages
GROUP BY Game
UNION ALL
SELECT
    ...
    AVG(Kills_mode2_team1_avg) as AvgKills
FROM processed_averages
GROUP BY Game
UNION ALL
SELECT
    ...
    AVG(Kills_mode2_team2_avg) as AvgKills
FROM processed_averages
GROUP BY Game
UNION ALL
SELECT
    ...
    AVG(Kills_mode3_team1_avg) as AvgKills
FROM processed_averages
GROUP BY Game
UNION ALL
SELECT
    ...
    AVG(Kills_mode3_team2_avg) as AvgKills
FROM processed_averages
GROUP BY Game
"""
